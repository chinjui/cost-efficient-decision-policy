...
policy0_returns = statistics.mean(policy0_returns)
policy1_returns = statistics.mean(policy1_returns)


macro_cost = 6.57
policy_costs = [20.01, 245.24]
...
# plt.xlim(0, 1)
# plt.ylim(0, 1)
textstr = "small policy: %.2f, large policy: %.2f\n" % (policy0_returns, policy1_returns)
